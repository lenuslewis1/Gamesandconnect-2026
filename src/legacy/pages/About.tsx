    ...
    <Layout>
        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-16">
            <div className="sticky top-24 h-fit">
              ...
              <Button asChild className="rounded-full bg-primary hover:bg-primary/90 text-primary-foreground px-8 h-12">
        ...
        <div className="container">
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div className="bg-white p-8 md:p-12 rounded-[2rem] shadow-sm border border-accent">
              <div className="space-y-6"><h3 className="text-3xl">Let’s make something happen.</h3><p>Questions about joining, a partnership, or an experience for your team? We would love to hear from you.</p><a href="/contact" className="gc-button">Get in touch →</a></div>
            </div>
      ...
      <section className="py-20 bg-primary my-12 mx-6 md:mx-12 rounded-[3rem] text-white text-center relative overflow-hidden">
        <div className="relative z-10 px-6">
          ...
          <Button asChild className="bg-white text-[#4d7c0f] hover:bg-accent/30 rounded-full px-8 h-12 text-lg">
