...
const Footer = () => {
    return (
        <footer className="bg-black text-[#fbfde9] pt-24 pb-12 border-t border-[#334155]">
                ...
                <div className="grid gap-16 md:grid-cols-2 lg:grid-cols-4 mb-20">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="flex gap-4">
                            <a href="https://www.instagram.com/games_connect_gh/" target="_blank" rel="noopener noreferrer" className="h-10 w-10 rounded-full border border-white/20 flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-all duration-300">
                                <Instagram className="h-5 w-5" />
                            </a>
                            <a href="https://x.com/GamesConnect_gh/" target="_blank" rel="noopener noreferrer" className="h-10 w-10 rounded-full border border-white/20 flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-all duration-300">
                                <Twitter className="h-5 w-5" />
                            </a>
                            <a href="https://facebook.com/gamesandconnect" target="_blank" rel="noopener noreferrer" className="h-10 w-10 rounded-full border border-white/20 flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-all duration-300">
                                <Facebook className="h-5 w-5" />
                            </a>
                            <a href="https://www.tiktok.com/@games_and_connect" target="_blank" rel="noopener noreferrer" className="h-10 w-10 rounded-full border border-white/20 flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-all duration-300">
                    ...
                    <div>
                        ...
                        <form className="space-y-3" onSubmit={(e) => e.preventDefault()}>
                            <div className="relative">
                                ...
                                />
                                <Button type="submit" size="sm" className="absolute right-2 top-2 h-10 w-10 rounded-lg bg-primary text-primary-foreground hover:bg-primary/90 p-0">
